...
/* 11 */
/*!***************************************!*\
  !*** D:/项目/uniapp_GLD/store/index.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    changeNum: function changeNum(state, num) {
      state.num = num;
    } },
...
/* 19 */
/*!***************************************!*\
  !*** D:/项目/uniapp_GLD/common/http.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // const baseUrl = 'http://192.168.1.57:50819/xcxmanageapi/';
var baseUrl = 'https://test.sqcsqc.com:50819/xcxmanageapi/'; //测试库 
// const baseUrl = 'https://xcustomer.sqcyouth.com:4439/xcxmanageapi/'; //正式库
var httpRequestGet = function httpRequestGet(url, data) {
  var httpDefaultOpts = {
    url: baseUrl + url,
    data: data,
    method: 'get',
...
var httpRequestPost = function httpRequestPost(url, data) {
  var httpDefaultOpts = {
    url: baseUrl + url,
    data: data,
    method: 'post',
...
/* 20 */
/*!*****************************************!*\
  !*** D:/项目/uniapp_GLD/common/common.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//获取手机屏幕高度
_vue.default.prototype.getWindowHeight = function () {
  var that = this;
  var height = 0;
  uni.getSystemInfo({
...
//获取当前时间，格式YYYY/MM/DD HH:MM:SS  ios端
var GetNowTimeIOS = function GetNowTimeIOS(time) {
  var date = time,
  year = date.getFullYear(),
  month = date.getMonth() + 1,
  day = date.getDate(),
...
var gshPhone = function gshPhone(phone) {
...
function checkTime(that) {
  var gqtime = uni.getStorageSync('gqTime') - Date.parse(new Date()) / 1000;
  // console.log(gqtime);
  if (gqtime <= 0) {
    uni.clearStorageSync();
    _vue.default.prototype.$mdList = [];
    _vue.default.prototype.$mdListData = [];
    _vue.default.prototype.$htData = [];
...
/* 29 */
/*!********************************************************!*\
  !*** D:/项目/uniapp_GLD/components/u-charts/u-charts.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
