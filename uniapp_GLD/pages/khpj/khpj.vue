<template>
	<view class="page">
		<view style="display: flex;justify-content: space-between;padding: 20upx 30upx;height: 100upx;align-items: center;background-color: #FFFFFF;">
			...
			<view @click="isShow = true" style="color: #007AFF;" v-if="HLSlength == 0">选择护理师 ▼</view>
			<view @click="isShow = true" style="color: #007AFF;" v-else>已选择 {{ HLSlength }} 个护理师 ▼</view>
			...
			<block v-for="(item, index) in dataList" :key="index">
				...
				<view class="gkBox" @click="clickRZXQ(item)">
					...
					<view style="flex: 2;text-align: right;align-self: center;">
						<image src="../../static/images/HYJpng/enter.png" style="width: 80upx;height: 80upx;margin-right: 10upx;" mode="aspectFit"></image>
					</view>
				</view>
			</block>
		</scroll-view>
