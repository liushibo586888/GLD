					...
					<block v-for="(item, index) in dataList" :key="index">
						...
						<view class="HLS_box">
							...
							<view class="HLS_zhong HLS_xia">
								<view>
									<text>{{ item.AscendingOrderNumber }}</text>
									<text>升单人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
								...
								<view>
									<text>{{ item.AscendingOrderAmount }}</text>
									<text>升单业绩</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.ExecuteAmount }}</text>
									<text>耗卡总金额</text>
								</view>
							</view>
							<view class="HLS_zhong HLS_xia">
								<view>
									<text>{{ item.ClinchRate }}</text>
									<text>成交率</text>
									<text class="xian_h"></text>
								</view>
								<view>
...
export default {
	...
	methods: {
		...
		getList(page = 1, size = 5) {
			let url = 'StatiStical/GetOldGuestToClinch';
			let data = {
