					...
					<block v-for="(item, index) in dataList" :key="index">
						<view class="HLS_box">
							...
							<view class="HLS_zhong HLS_xia">
								<view>
									<text style="font-weight: bold;">{{ item.TotalPerformance }}</text>
									<text class="fontSize">总业绩</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<!-- 新增 -->
									<text style="font-weight: bold;">{{ item.ProductAmount }}</text>
									<text class="fontSize">产品业绩</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="font-weight: bold;">{{ item.NewPerformance }}</text>
									<text class="fontSize">新客业绩</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="font-weight: bold;">{{ item.OldPerformance }}</text>
									<text class="fontSize">老客业绩</text>
								</view>
							</view>
							<view class="HLS_zhong HLS_xia">
								<view>
									<text style="font-weight: bold;">{{ item.NewComNum }}</text>
									<text class="fontSize">服务新客人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="font-weight: bold;">{{ item.OldComNum }}</text>
									<text class="fontSize">服务老客人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
							...
							<view class="HLS_zhong HLS_xia">
								<!-- 新增 -->
								<view>
									<text style="font-weight: bold;">{{ item.ClosingRatio }}</text>
									<text class="fontSize">总成交率</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="font-weight: bold;">{{ item.ClosingRatioForqd }}</text>
									<text class="fontSize">祛痘成交率</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="font-weight: bold;">{{ item.SuggestNum }}</text>
									<text class="fontSize">转介绍人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="font-weight: bold;">{{ item.Suggestformance }}</text>
									<text class="fontSize">转介绍成交数</text>
								</view>
							</view>
						</view>
					</block>
...
export default {
	...
	methods: {
		...
		getList(page = 1, size = 5) {
			let url = 'Performance/GetPractitionerResultsDirector';
			let data = {
