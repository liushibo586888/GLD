<template>
	<view class="page">
		...
		<!-- 使用 swiper 配合 滑动切换 -->
		<view style="display: flex;justify-content: space-between;height: 70upx;padding: 20upx;">
			<view class=""></view>
					...
					<block v-for="(item, index) in dataList" :key="index">
						...
						<view class="HLS_box">
							<view style="background: #FFFFFF;height: 60upx;">
								<view class="HLS_shang">{{ item.StoreName }}</view>
								<view v-if="Sort == 0">
							...
							<view class="HLS_zhong">
								<view>
									<text>{{ item.ReservationNumber }}</text>
									<text>预约人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.ClinchNumber }}</text>
									<text>成交人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.LossNumber }}</text>
									<text>流失人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.LossRate }}</text>
									<text>流失率</text>
								</view>
							</view>
							<view class="HLS_zhong HLS_xia">
								<!-- 新增 -->
								<view>
									<text>{{ item.ToShopNumber }}</text>
									<text>到店人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.OnLineToShopNum }}</text>
									<text>线上到店人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.IntroductionToShopNum }}</text>
									<text>转介绍人数</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.NaturalToShopNum }}</text>
									<text>自然到店人数</text>
								</view>
							</view>
							<view class="HLS_zhong HLS_xia">
								<!-- 新增 -->
								<view>
									<text>{{ item.StoreRate }}</text>
									<text>线上到店率</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.IntroductionRate }}</text>
									<text>转介绍成交率</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.ClinchAmount }}</text>
									<text>成交业绩</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.OnLineAmount }}</text>
									<text>线上成交业绩</text>
								</view>
							</view>
							...
							<view class="HLS_zhong HLS_xia">
								<!-- 新增 -->
								<view>
									<text>{{ item.OnLineRate }}</text>
									<text>线上到店成交率</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.NaturalRate }}</text>
									<text>自然到店成交率</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.IntroductionAmount }}</text>
									<text>转介绍成交业绩</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text>{{ item.NaturalAmount }}</text>
									<text>自然到店成交业绩</text>
								</view>
							</view>
						</view>
...
export default {
	...
	methods: {
		...
		getList(page = 1, size = 5) {
			let url = 'StatiStical/GetNewGuestToClinch';
			let data = {
