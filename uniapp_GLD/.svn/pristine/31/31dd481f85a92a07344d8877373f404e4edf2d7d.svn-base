				...
				<scroll-view scroll-y="true" style="height: 100%;padding: 10upx 10upx;box-sizing: border-box;" @scrolltolower="scrolltolower">
					<block v-for="(item, index) in dataList" :key="index">
						...
						<view style="display: flex;margin-bottom: 20upx;">
							...
							<view class="xm_box">
								<view v-if="index < 3 && Sort == 0">
									<image v-if="index == 0" class="xm_box_img" src="../../static/images/HYJpng/Gjun.png"></image>
									<image v-if="index == 1" class="xm_box_img" src="../../static/images/HYJpng/Yjun.png"></image>
									<image v-if="index == 2" class="xm_box_img" src="../../static/images/HYJpng/Jjun.png"></image>
								</view>
								<view style="color: #f5765d;font-weight: bold;" v-else><image class="xm_box_img" src="../../static/images/HYJpng/nuli.png"></image></view>
