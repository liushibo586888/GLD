					...
					<block v-for="(item, index) in dataList" :key="index">
						<view class="HLS_box">
							...
							<view class="HLS_zhong">
								<view>
									<text style="color: #ff9917;font-weight: bold;">{{ item.TotalPerformance }}</text>
									<text class="fontSize" style="color: #a2a2a2;">总业绩</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="color: #8dabff;font-weight: bold;">{{ item.NewComNum }}</text>
									<text class="fontSize" style="color: #a2a2a2;">服务新客(次)</text>
									<text class="xian_h"></text>
								</view>
								<view>
									<text style="color: #8dabff;font-weight: bold;">{{ item.OldComNum }}</text>
									<text class="fontSize" style="color: #a2a2a2;">服务老客(次)</text>
								</view>
							</view>
